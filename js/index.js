//
// TURNS OUT I DONT NEED THIS THERE IS AN ANIMATION FEATURE IN AFRAME


// ======= This works but i cant figure oout  ========== //

// const chepCube = document.getElementById('chep-cube')

// const animateUp = (object, Zposition) => {
//     const position = `x:0 , y:${Math.floor(0 + -Math.tan(Date.now()) / 1000)}, `;
    

//     object.setAttribute('position', {x: 0, y:0.6 + Math.tan(Math.random() * -9) / -3, z: 0 });
